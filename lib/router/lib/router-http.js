					...
					let handler = async (req, res) => {
						...
						try{
							...
							for (let i = 0; i < beforeHandlers.length; i++) {
								await Reflection.invoke(beforeHandlers[i], controller, {req, res, request: req, response: res, params: req.params});
							}
							...
							for (let i = 0; i < afterHandlers.length; i++) {
								await Reflection.invoke(afterHandlers[i], controller, {req, res, request: req, response: res, params: req.params});
							}
